...
private:
	...
	double _q[3][3];				///< current joint angle (radian)
	double _q_filtered[3][3];		///< current joint angle (radian, low pass filtered)
	double _q_pre[3][3];			///< previous(last) joint angle (radian)
	double _q_filtered_pre[3][3];	///< previous(last) joint angle (radian, low pass filtered)
	double _qdot[3][3];				///< joint velocity (radian/sec)
	double _qdot_filtered[3][3];	///< joint velocity (radian/sec, low pass filtered)
	double _qdot_pre[NOF][NOJ];			///< previous(last) joint velocity (radian/sec)
	double _tau_des[3][3];			///< desired joint torque
	...
	double q_error[NOF][NOJ], q_error_sum[NOF][NOJ], init_q[NOF][NOJ], final_q[NOF][NOJ];
	double q_error1[NOF][NOJ], dq_error1[NOF][NOJ];
	double a[NOF][NOJ], b[NOF][NOJ], c[NOF][NOJ], d[NOF][NOJ];
};
